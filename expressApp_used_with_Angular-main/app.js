...
const connection = mongoose.connect("mongodb+srv://admin:admin@cluster0.k5f4w.mongodb.net/myFirstDatabase?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true });
var app = express();
connection.then((db) => {
